...
document.addEventListener("DOMContentLoaded", function() {
    var phoenixIsRTL = window.config && window.config.config && window.config.config.phoenixIsRTL;

    var styleDefault = document.getElementById('style-default');
    var styleRTL = document.getElementById('style-rtl');
    ...
    if (phoenixIsRTL) {
        ...
        userDefault.disabled = true;
        styleRTL.disabled = false;
        userRTL.disabled = false;

        document.documentElement.setAttribute('dir', 'rtl');
    } else {
        // Enable LTR styles
        styleDefault.disabled = false;
        userDefault.disabled = false;
        styleRTL.disabled = true;
        userRTL.disabled = true;
    ...
    <main class="main" id="top">
      <div class="container">
        <div class="row flex-center min-vh-100 py-5">
          <div class="col-sm-10 col-md-8 col-lg-5 col-xl-5 col-xxl-3"><a class="d-flex flex-center text-decoration-none mb-4" href="../../../index.html">
              <div class="d-flex align-items-center fw-bolder fs-3 d-inline-block"><img src="../../../assets/img/icons/logo.png" alt="phoenix" width="100" /></div>
            </a>
            ...
            <div class="mb-3 text-start"><label class="form-label" for="password">Password</label>
              <div class="form-icon-container" data-password="data-password"><input class="form-control form-icon-input pe-6" id="password" type="password" placeholder="Password" data-password-input="data-password-input" /><span class="fas fa-key text-body fs-9 form-icon"></span></div>
            </div>
     ...
     src="<%= ResolveUrl("~/assets/img/team/30.webp") %>" 
     alt="" />
</div>
