    ...
    public partial class employees : System.Web.UI.Page
    {
        ...
        protected async void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                await Task.WhenAll(
                    SaveEmployeeContactInfo(basicInfo),
                    SaveEmployeeEmploymentInfo(basicInfo),
                    SaveEmployeeAttendanceInfo(basicInfo),
                    SaveEmployeePayrollInfo(basicInfo),
                    SaveEmployeeLegalInfo(basicInfo)
                );
