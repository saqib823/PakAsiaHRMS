<%@ Page Title="Add Designations" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="designation.aspx.cs" Inherits="hrms_PakAsia.Pages.Organization.designation" %>
        ...
        <div class="container">
            ...
            <div class="row py-5">
                ...
                <div class="text-center mb-4">
                    <h3 class="mt-3">Add Designation</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3 mt-3">
                        ...
                        <asp:TextBox CssClass="form-control" ID="Designation" runat="server" placeholder="Enter Designation Name"></asp:TextBox>
                    </div>
